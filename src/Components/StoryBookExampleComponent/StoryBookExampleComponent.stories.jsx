...
import { useState } from 'react';
import StoryBookExampleComponent from './StoryBookExampleComponent';
>>>>>>> 406de8a6b96b8427e54c85efc9a66c0c18b0f2f9
...
const Template = ({ primary, label, color, backgroundColor, padding, fontSize, fontWeight, textAlign, margin, footer, name }) => (
        <div>
            <StoryBookExampleComponent {...{primary, label, color, backgroundColor, padding, fontSize, fontWeight, textAlign, margin, footer, name}} />
        </div>
    )
